...
#region Phase 4 Sprint 1 - Audio Manager Expanded Clips
using UnityEngine;
...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip lostLifeClip;
    [SerializeField] private AudioClip quarterzipClip;
    [SerializeField] private AudioClip footballThrowClip;
    #endregion
    ...
    {
        sfxSource.PlayOneShot(lostLifeClip);
    }

    public void PlayQuarterzip()
    {
        sfxSource.PlayOneShot(quarterzipClip);
    }

    public void PlayFootballThrow()
    {
        sfxSource.PlayOneShot(footballThrowClip);
    }
    #endregion
