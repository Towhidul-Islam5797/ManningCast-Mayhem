...
//    public void HandleSandwichHit(int scorePenalty, float timePenaltySeconds)
//    {
//        GameManager.Instance.PlayerHitSandwich(scorePenalty, timePenaltySeconds);
//    }
//    #endregion
...
//    private Vector3 startPosition;
//    private Vector2Int facingDirection = Vector2Int.down;
//    private float furthestPositionReached;
//    #endregion
...
//        bodyCollider = GetComponent<BoxCollider2D>();
//        startPosition = transform.position;
//        furthestPositionReached = transform.position.y;
//    }
//    #endregion
...
//        if (transform.position.y > furthestPositionReached)
//        {
//            furthestPositionReached = transform.position.y;
//            GameManager.Instance.AddLaneProgressScore();
//        }
...
//        if (!isRiding && IsHazardAt(transform.position))
//        {
//            HandleObstacleHit(hazardScorePenalty);
//            yield break;
//        }
...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void OnInteractPerformed(InputAction.CallbackContext context)
    {
        ...
        AudioManager.Instance.PlayFootballThrow();
